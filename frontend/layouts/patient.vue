    ...
    <header class="sticky top-0 z-50 glass border-b border-[var(--color-border)]">
      ...
      <nav class="md:hidden flex items-center justify-around border-t border-[var(--color-border)] px-2 py-1">
        <NuxtLink
          ...
          :class="isActive('/patient') ? 'text-primary-600 dark:text-primary-400' : 'text-[var(--color-text-muted)]'"
        >
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <NuxtLink
          to="/patient/tickets"
          class="flex flex-col items-center gap-1 p-2 rounded-lg text-xs"
          :class="isActive('/patient/tickets') ? 'text-primary-600 dark:text-primary-400' : 'text-[var(--color-text-muted)]'"
        >
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <NuxtLink
          to="/patient/chatbot"
          class="flex flex-col items-center gap-1 p-2 rounded-lg text-xs"
          :class="isActive('/patient/chatbot') ? 'text-primary-600 dark:text-primary-400' : 'text-[var(--color-text-muted)]'"
        >
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <NuxtLink
          to="/patient/about"
          class="flex flex-col items-center gap-1 p-2 rounded-lg text-xs"
          :class="isActive('/patient/about') ? 'text-primary-600 dark:text-primary-400' : 'text-[var(--color-text-muted)]'"
        >
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const tabs = [
  { to: '/patient', label: 'nav.home' },
  { to: '/patient/tickets', label: 'nav.tickets' },
  { to: '/patient/chatbot', label: 'nav.chatbot' },
  { to: '/patient/about', label: 'nav.about' },
]
